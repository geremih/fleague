...
(function() {
  ...
  ready = function() {
    var populateTeamField, randomScore, sortPlayers, update_team;
    update_team = function() {
      return $('.match-schedule-select-team-list li').each(function(index, element) {
        return console.log($(element).attr("data-player-id"));
      });
    };
    ...
    $(".match-schedule-connected1").on("sortchange", function(event, ui) {
      return alert("Hello");
    });
    $(".match-schedule-connected").on("sortchange", function(event, ui) {
      return alert("Hello");
    });
    populateTeamField = function(e) {
      var team;
      ...
      team = [];
      $('.match-schedule-select-team-list li').each(function(index, element) {
        return team.push($(element).attr("data-player-id"));
      });
    ...
    randomScore = function() {
      return $('.player-score-input').each(function(index, element) {
        return $(element).val(Math.floor(100 * Math.random()));
      });
    };
    $("#match-schedule-form").submit(function() {
      return populateTeamField();
    });
    sortPlayers = function() {
      var listitems, mylist, up;
      ...
      listitems.sort(function(a, b) {
        if (up) {
          return parseFloat($(a).children('span').text()) - parseFloat($(b).children('span').text());
        } else {
          return parseFloat($(b).children('span').text()) - parseFloat($(a).children('span').text());
        }
      });
      return $.each(listitems, function(idx, itm) {
        return mylist.append(itm);
      });
    };
    $('#match-schedule-sort-button').click(function() {
      return sortPlayers();
    });
    return $('.match-schedule-remaining-players-list').slimScroll({
      height: '500px'
    });
  };
...
(function() {
  ...
  ready = function() {
    var populateTeamField, randomScore, sortPlayers, update_team;
    update_team = function() {
      return $('.user-team-list li').each(function(index, element) {
        return console.log($(element).attr("data-player-id"));
      });
    };
    $('.connected').sortable({
    ...
    populateTeamField = function(e) {
      ...
      team = [];
      $('.user-team-list li').each(function(index, element) {
    ...
    return $('.remaining-players-list').slimScroll({
      height: '462px'
    });
  };
